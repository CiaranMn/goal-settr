...
k_goal = Goal.create(name: "Learn Rails", user_id: 2, description: "Learning rails is fun and useful.", overall_goal: "Rails Master", due_date: Date.parse("07/12/2018"), daily_goal: "Do 5 labs", category: education)
